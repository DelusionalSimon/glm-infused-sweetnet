...
- After an insane race to finish in time I'm finally done. In the very end I found that I never included the Test set tests. But I got in pretty much everything else. Including a last-minute zenodo database (https://zenodo.org/records/15548889) and a new clean Github Repo. I have a feeling this isn't the end of it. I've been done for an hour, just tieing up loose ends. Time to shut down the computer and go home to get some sleep.
